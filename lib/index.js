...
function processResponse(plugins, res, req, done) {
  ...
  // We pass this partially applied `sendAndProcessResponse` function
  // in to the plugin, in case it needs to trigger another send.
  // We apply the plugins here to  avoid exposing the plugins
  // to each other.
  send = sendAndProcessResponse.bind(null, plugins);
