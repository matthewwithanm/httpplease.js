...
function factory(defaults, plugins) {
  ...
  function http(req, cb) {
    ...
    req.xhr = xhr;
    sendAndProcessResponse(plugins, req, defaults, done);
 ...
 */
function sendAndProcessResponse(plugins, req, defaults, done) {
  ...
  checkIfDone = function(rawError) {
    ...
    processResponse(plugins, res, req, defaults, function(processedRes) {
      var error, response;
 ...
 */
function processResponse(plugins, res, req, defaults, done) {
  ...
  send = function(newReq) {
    ...
    sendAndProcessResponse(plugins, newReq, defaults, done);
  };
